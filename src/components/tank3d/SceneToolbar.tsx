...
export function SceneToolbar({ canUndo, canRedo, onUndo, onRedo, onResetLayout }: Props) {
  ...
  return (
    <>
      <div className="pointer-events-none absolute right-2 top-2 z-10 flex gap-2 sm:right-3 sm:top-3">
      ...
      <div className="pointer-events-none absolute left-2 top-2 z-10 flex gap-2 sm:left-3 sm:top-3">
