...
export default function VisualiserCanvas({state,setState,history}: {state: TankState; setState: (update: (s: TankState) => TankState) => void; history: ReturnType<typeof useTankHistory>}) {
