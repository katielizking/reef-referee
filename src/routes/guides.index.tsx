...
const guides: GuideItem[] = [
  ...
  },
  {
    ...
    excerpt:
      "What your water is really telling you, and when to leave it alone.",
  ...
  },
  {
    ...
    excerpt:
      "Sponge vs HOB vs canister — turnover, media and what actually matters.",
    category: "Filtration",
    soon: true,
  },
  {
    ...
    excerpt:
      "Light, CO₂, substrate and the easiest carpet plants for beginners.",
    category: "Plants",
    soon: true,
  },
  {
    ...
    excerpt:
      "A simple 2-week protocol that stops one sick fish taking out the tank.",
    category: "Quarantine",
    soon: true,
  },
  {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground">
        Deep-dive articles on the biology and gear behind a healthy freshwater
        tank. Built to be useful wherever you keep fish; always check local
        water and wildlife rules when they apply.
      </p>
